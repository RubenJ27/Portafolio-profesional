  ...
  return (
    <>
      <div
        ...
        id="contact"
      >
        <h1 className="flex container text-white font-bold text-3xl w-full my-12">Contacto</h1>
        <div className="container flex justify-evenly w-full h-full mb-12">
          <div className="flex flex-col xl:flex-row justify-between w-full h-2/4">
            ...
            <div className="flex flex-col w-[100%] h-2/5 bg-primary-color lg:w-auto lg:static mr-0 xl:mr-5 mb-5 xl:mb-0 justify-between rounded-xl px-3 sm:px-16 py-10">
              <h1 className="text-white font-bold text-3xl w-full mb-3">Hablemos de lo que necesitas</h1>

              {/* click contact */}
              <div className="flex">
                <p className="text-white">¿No te gustan los formularios? Envíame un</p>{" "}
                <a
                  href="https://api.whatsapp.com/send?phone=573224675055&text=Hola, Necesito mas informacion para realizar un proyecto!"
                  target="_blank"
                  className="text-quinario-color-complement cursor-pointer font-medium mx-2"
                >
                  mensaje privado
                </a>{" "}
                <FontAwesomeIcon icon={faWhatsapp} className="text-white ml-2 hidden sm:flex text-2xl my-auto" />
              </div>
            </div>
              ...
              >
                <div className="mb-6">
                  ...
                  {errors.name?.type === "minLength" && (
                    <p className="text-red-600 font-bold ml-1 mt-2">
                      {" "}
                      <FontAwesomeIcon icon={faTriangleExclamation} className="text-red-600 pt-1 text-2xl mr-2" />
                ...
                <button
                  type="submit"
                  className="flex justify-center bg-quinario-color-complement text-white w-[60%] sm:w-[35%] md:w-[40%] xl:w-2/4 h-2/3  px-18 rounded-3xl items-center py-2 mr-5"
                >
                  <FontAwesomeIcon icon={faEnvelope} className="text-white ml-2 text-2xl my-auto mr-3" /> Enviar mensaje
                </button>
              </form>
            </div>
          </div>
