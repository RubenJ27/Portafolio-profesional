...
export default function HomePage() {
  return (
    <>
      <div
        className="bg-primary-color flex bg-[url('/beautiful-geometric.png')] relative z-10 w-full justify-center"
        id="home"
      >
        <div className="flex flex-col justify-start mt-6 z-30">
          ...
          <div className="flex justify-center">
            ...
            <a
              href="https://resume.io/r/I4dbzYlVX"
              target="_blank"
              className="flex bg-quinario-color-complement text-white w-[45%] h-[70%] rounded-3xl items-center mr-5"
            >
            ...
            <a
              href="https://github.com/RubenJ27"
              target="_blank"
